...
export default function Profile(){
    return(
        <section id="#bio" className="p-8 font-mono text-white w-full " >
            <motion.div initial={{opacity:0, scale:0}} transition={{delay:.2, duration: .3}} animate={{opacity:1, scale:1}} className="lg:flex drop-shadow-[3px_8px_7px_black] transition-drop-shadow duration-500 hover:drop-shadow-[0px_0px_7px_#FFFFFFE3] xl:gap-8 bg-[#0B0B0B] p-7">
