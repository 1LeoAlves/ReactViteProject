...
function NavMenu(){
    return(
        <section className="w-full h-30 bg-gradient-to-r from-[rgb(64,7,64)] via-[rgb(35,11,58)] to-[rgb(68,9,82)] flex justify-between shadow-[0px_10px_8px_rgba(0,0,0,.35)] font-mono text-white">
            <motion.div className="flex" initial={{ x: -500, opacity: 0}} animate={{ ease: "easeInOut", x: 0.1, opacity: 1, transition: {duration:.5}}}>
                ...
                <h1 className=" flex justify-center items-center text-left text-nowrap text-6xl sm:text-5xl transition-transform-drop-shadow duration-300 drop-shadow-[0px_0px_3px_white] hover:drop-shadow-[0px_0px_8px_white] hover:scale-102 tracking-tight">Leo Alves</h1>
            </motion.div>
